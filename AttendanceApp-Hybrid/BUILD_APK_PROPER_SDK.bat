...
REM Step 2: Stop all Gradle daemons
...
REM Step 3: Kill processes that might interfere
echo Step 3: Killing interfering processes...
echo ========================================
...
REM Step 4: Remove old APK files
echo Step 4: Removing old APK files...
echo ========================================
...
REM Step 5: Build the release APK
...
REM Step 6: Check build result and copy APK
echo Step 6: Processing build result...
echo ========================================
if %BUILD_RESULT% EQU 0 (
    ...
    if exist "android\app\build\outputs\apk\release\app-release.apk" (
        ...
        REM Step 7: Install APK on device
        echo Step 7: Installing APK on connected device...
        echo ========================================
